...
from ts_benchmark.baselines.dag_rope.models.dag_rope_model import DAG_ropeModel
...
class DAG_rope(DeepForecastingModelBase):
    """
    DAG adapter class.
    ...
    def __init__(self, **kwargs):
        super(DAG_rope, self).__init__(MODEL_HYPER_PARAMS, **kwargs)
    ...
    def _init_model(self):
        return DAG_ropeModel(self.config)
