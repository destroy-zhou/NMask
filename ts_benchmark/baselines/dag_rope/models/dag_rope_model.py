...
from ts_benchmark.baselines.dag_rope.layers.CC_EncDec import CovCausalityEncoder
from ts_benchmark.baselines.dag_rope.layers.TC_EncDec import TemporalCausalityEncoder


class DAG_ropeModel(nn.Module):
    def __init__(self, config):
        super(DAG_ropeModel, self).__init__()
